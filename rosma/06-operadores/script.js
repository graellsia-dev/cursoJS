...
console.log("total, ", multiplicar)

let cuadrado = numeroA**2
console.log("total, ", cuadrado)

let dividir = numeroA / numeroB
console.log("total, ", dividir)

let raiz = Math.sqrt(numeroB)
console.log("total, ", raiz)
